...
pnpm --filter @villa/hub test:unit
pnpm --filter @villa/hub test:integration
pnpm --filter @villa/hub test:e2e:chromium
pnpm --filter @villa/hub test:security

# Watch mode (development)
pnpm --filter @villa/hub test:unit --watch
```
...
pnpm --filter @villa/hub test:e2e --reporter=html

# Run single test file
pnpm --filter @villa/hub test:e2e tests/e2e/auth.spec.ts

# Debug mode (headed browser)
pnpm --filter @villa/hub test:e2e:headed
...
pnpm --filter @villa/hub test:e2e --repeat-each=3
```
