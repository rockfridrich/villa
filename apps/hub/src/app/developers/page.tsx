 ...
 * Shows hero, features, and connect Villa ID CTA.
 */
export default function DevelopersPage() {
  ...
  const handleConnect = async () => {
    ...
    // Developer Villa ID connection via Porto SDK
    ...
    try {
      ...
      if (typeof window !== "undefined" && "porto" in window) {
        // Production: Use Porto SDK for Villa ID connection
  ...
  return (
    <main className="min-h-screen bg-cream-50">
      <DeveloperLanding onConnect={handleConnect} isConnected={isConnected} />
    </main>
  );
}
