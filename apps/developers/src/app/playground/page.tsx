          ...
          >
            ...
            <div className="space-y-6">
              ...
              <p className="text-xl text-ink-muted leading-relaxed max-w-lg">
                Add passkey authentication to your app in minutes. Zero backend.
                Zero config. Just pure UX.
              </p>
            </div>
          ...
          >
            <div className="relative z-10 bg-white rounded-3xl border border-ink/5 shadow-villa-lg overflow-hidden backdrop-blur-xl">
              <div className="px-6 py-4 border-b border-ink/5 bg-cream-50/50 flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  <div
                    className={`w-2 h-2 rounded-full ${user ? "bg-green-500" : "bg-amber-500 animate-pulse"}`}
                  />
                    ...
                    >
                      ...
                      <div className="space-y-2">
                        ...
                        <p className="text-sm text-ink-muted">
                          Click the button on the left to experience the
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            <div className="space-y-4">
              <div className="flex items-center gap-2 text-ink font-medium">
                <div className="w-6 h-6 rounded-full bg-ink text-white flex items-center justify-center text-xs">
                  1
                </div>
