        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <div className="flex flex-wrap gap-4 pt-4">
            <a
              ...
              className="inline-flex items-center gap-2 bg-[#0D0D17] text-white px-6 py-3 rounded-xl hover:bg-[#0D0D17]/80 transition-all"
            >
              <Github className="w-4 h-4" /> Source Code
            </a>
            <Link
              href="/sdk"
              className="inline-flex items-center gap-2 border border-[#0D0D17]/10 px-6 py-3 rounded-xl hover:bg-[#0D0D17]/5 transition-all"
            >
      ...
      <div className="max-w-4xl mx-auto px-6 pb-24 space-y-24">
          ...
          <div className="bg-white p-8 rounded-2xl border border-[#0D0D17]/5 shadow-sm space-y-6">
            ...
            <ol className="space-y-6 relative border-l-2 border-[#0D0D17]/5 ml-3 pl-8">
              <li className="relative">
                <span className="absolute -left-[39px] w-5 h-5 rounded-full bg-[#FFE047] flex items-center justify-center text-xs font-bold ring-4 ring-[#FFFDF8]">
                  1
                </span>
                <h3 className="font-medium text-lg">Initiation</h3>
                <p className="text-[#0D0D17]/60 mt-1">
                  App calls{" "}
                  <code className="text-sm bg-[#0D0D17]/5 px-1.5 py-0.5 rounded">
                    villa.signIn()
                  </code>
              ...
              <li className="relative">
                ...
                <p className="text-[#0D0D17]/60 mt-1">
                  ...
                  <code className="text-sm bg-[#0D0D17]/5 px-1.5 py-0.5 rounded">{`{ address, nickname, avatar }`}</code>
                  .
                </p>
              </li>
            </ol>
        ...
        <section id="contracts" className="space-y-8">
          ...
          <div className="grid gap-6">
            <div className="bg-white p-6 rounded-2xl border border-[#0D0D17]/5 shadow-sm">
              ...
              <p className="text-[#0D0D17]/60 mb-4 text-sm">
              ...
              <div className="flex items-center gap-2 p-3 bg-[#0D0D17]/[0.02] rounded-lg border border-[#0D0D17]/5 overflow-hidden">
                ...
                <span className="text-xs text-[#0D0D17]/40 font-medium px-2 py-1 bg-[#0D0D17]/5 rounded">
                  Base Sepolia
                </span>
              </div>
            </div>
            ...
            <div className="grid sm:grid-cols-2 gap-8">
              ...
              <div className="space-y-2">
                ...
                <p className="text-[#0D0D17]/60 text-sm leading-relaxed">
                  ...
                  <code className="text-xs bg-[#0D0D17]/5 px-1 rounded">
                    key.villa.cash
                  </code>
        ...
        <section className="pt-8 border-t border-[#0D0D17]/5">
          <div className="grid sm:grid-cols-2 gap-6">
            <Link
              href="/sdk"
              className="group p-6 rounded-2xl bg-[#0D0D17]/[0.02] hover:bg-[#0D0D17]/5 transition-all"
            >
              ...
              <p className="text-[#0D0D17]/60 text-sm">
